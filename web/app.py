    ...
    if show_guide and col2 is not None:
        with col2:
            ...
            with st.expander("🎯 快速开始", expanded=True):
                ...
                1. **输入股票代码**
                   - A股示例: `002115` (平安银行), `600519` (贵州茅台), `000858` (五粮液)
            ...
            with st.expander("🧠 AI模型说明"):
                ...
                💡 **推荐**: 日常分析使用 `qwen-plus`，重要决策使用 `qwen3-max`
                """)
            ...
            with st.expander("❓ 常见问题"):
                ...
                **Q: A股代码格式是什么？**
                A: A股使用6位数字代码，如 `002115`、`600519`、`000858` 等。
